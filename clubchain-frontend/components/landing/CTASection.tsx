    ...
    <div className="relative z-10 flex flex-col items-center gap-6 animate-slideUp animation-delay-600 px-4">
      ...
      <div className="flex gap-4 mt-4">
        <button
          ...
          className="text-gray-600 hover:text-gray-900 font-medium underline underline-offset-4 transition-colors flex items-center gap-1 group"
        >
      ...
      {/* Info text */}
      <p className="text-sm text-gray-500 max-w-md text-center mt-4 flex items-center gap-2 justify-center">
